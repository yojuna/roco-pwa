...
function startVideoProcessing() {
  ...
  // // aruco = new cv.aruco;
  // dictionary = new cv.aruco.getPredefinedDictionary(cv.DICT_6X6_250);
...
function processVideo() {
  ...
  switch (controls.filter) {
    ...
    case 'aruco': result = aruco_process(src); break;
...
function initUI() {
  ...
  controls = {
    ...
    aruco: function() { this.setFilter('aruco'); },
  ...
  let aruco = gui.add(controls, 'aruco').name(filters['aruco']).onChange(function() {
    closeLastFolder(null);
  });
