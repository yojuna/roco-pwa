...
(async function() {
  ...
  console.log("isArSessionSupported: ", isArSessionSupported)
...
class App {
  ...
  createXRCanvas() {
    ...
    console.log('createXRCanvas() complete');
  }
  ...
  onSessionStarted = async () => {
    console.log('onSessionStarted() starts');
    ...
    console.log('init done. sunflower event listener added');
  }
  ...
  setupThreeJs() {
    ...
    console.log('ThreeJS scene setup complete');
