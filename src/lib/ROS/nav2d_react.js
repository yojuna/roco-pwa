...
NAV2D.OccupancyGridClientNav = function(options) {
  ...
  var continuous = options.continuous || 'continuous';
  ...
  client.on('change', function() {
    ...
    that.viewer.shift(client.currentGrid.pose.position.x + offset, client.currentGrid.pose.position.y+ offset);

    console.log('OGM options: ', options)
    console.log('client.currentGrid: ', client.currentGrid)
